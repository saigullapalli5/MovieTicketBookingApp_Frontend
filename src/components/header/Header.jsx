...
const Header = () => {
  ...
  // Public pages (e.g., Movie Details) remain accessible without user auth
      ...
      <nav className={`header`}>
        ...
        {menu && (
          <ul className="menu">
            ...
            <li>
              <span className="iMoviesIcon" onClick={() => setSearch(!search)}>i</span>
            </li>
            <li>
        ...
        <div className="searchIconsContainer">
          <div className="searchContainer">
            ...
            />
            <button>
              <span className="iMoviesIcon">i</span>
            </button>
          </div>
