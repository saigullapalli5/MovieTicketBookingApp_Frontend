...
const MovieDetails = () => {
  ...
  const genres = typeof movieDetails?.genres === 'string' ? movieDetails.genres.split(",") : [];
      ...
      {!loading ? (
        <>
          <div className="movieDetailsContainer">
            {/* Trailer Card */}
            <TrailerCard movie={movieDetails} />

            <div className="detailsContainer">
              <div className="left">
                <img src={movieDetails?.media || "/images/rrrimages.webp"} />
              </div>
              <div className="right">
                <h4>{`${
